...
Original file is located at
    https://colab.research.google.com/drive/1BFPMfTeLMTSn9BuEEqRO-J1Hx1Fz9oJ8
"""
...
model2 = AdaBoostRegressor(n_estimators=500, learning_rate=0.01, loss='linear', random_state=42)
