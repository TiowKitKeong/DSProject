...
# ------------- SETTINGS --------------------
stocks = ['Please select stock','TSLA', 'AMZN','TLT','BAC', 'T', 'INTC', 'GOOGL', 'NFLX']
...
if selected == "Stock Predictions":
    st.write("""[**TSLA**: Tesla Inc, **AMZN**: Amazon Inc, **TLT**: iShares 20+ Year Treasury Bond ETF, **BAC**: Bank of America Corporation, **T**: AT&T Inc, **INTC**: Intel Corporation, **GOOGL** :Alphabet Inc, **NFLX**: Netflix, Inc]""")
